  ...
  const addRecentPhoto = async () => {
    try {
      ...
      if (!result.canceled) {
        ...
        await AsyncStorage.setItem("Fotos Recentes", JSON.stringify(updatedPhotos));
      }
    } catch (error) {
    ...
    <ScrollView style={styles.container}>
      ...
      <Card style={styles.gallerySection}>
        ...
        <Card.Content>
          ...
          <Button
            ...
            style={styles.saveButton} // Usa o mesmo estilo do botão "Salvar"
          >
            Adicionar Fotos
          </Button>
        </Card.Content>
      ...
      <View style={[styles.buttonContainer, { height: "20%", justifyContent: "space-evenly" }]}>
        <Button
          ...
          style={styles.termsButton} // Estilo específico para o botão "Termos"
        >
          Termos
        </Button>
        ...
        <Button
          ...
          style={styles.logoutButton} // Estilo específico para o botão "Desconectar"
        >
          Desconectar
        </Button>
      </View>
